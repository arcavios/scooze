...
class Card(SQLModel, table=True):
    ...
    rulings_uri: str = Field(description="A link to rulings for this card in Scryfall's API.")
    scryfall_uri: str = Field(description="A link to the Scryfall page for this card.")
    uri: str = Field(
        default=None,
    ...
    cmc: float = Field(description="This card's mana value/converted mana cost.")
    color_identity: set[Color] = Field(description="This card's color identity, for Commander variant deckbuilding.")
    ...
    defense: str | None = Field(
        default=None,
        description="This card's defense, if any.",
    )
    ...
    game_changer: bool | None = Field(
        default=None,
        description="True if this card is on the Commander Game Changers list.",
    )
    ...
    name: str = Field(description="This card's name.")
    ...
    # This is typed to include all of CostSymbol but really only needs "C" and "T".
    # Doing it this way to keep Color clean and not put "C" and "T" in there.
    produced_mana: set[Color | CostSymbol] | None = Field(
        default=None,
        description="Which colors of mana this card can produce.",
    )
    reserved: bool = Field(description="Whether this card is on the Reserved List.")
    toughness: str | None = Field(
        default=None,
        description="Toughness of this card, if applicable.",
    )
    type_line: str = Field(description='This card\'s type line. (e.g. "Creature — Ooze")')
    ...
    booster: bool = Field(description="Whether this card can be opened in booster packs.")
    border_color: BorderColor = Field(
        description="Border color of this card, from among black, white, borderless, silver, and gold."
    )
    card_back_id: str = Field(description="Scryfall UUID of the card back design for this card.")
    collector_number: str = Field(description="This card's collector number; can contain non-numeric characters.")
    ...
    digital: bool = Field(description="True if this card was only released in a video game.")
    ...
    frame: Frame = Field(description="This card's frame layout; see [here](https://scryfall.com/docs/api/frames)")
    full_art: bool = Field(description="Whether this print is full-art.")
    games: set[Game] = Field(
        default=set(),
        description="Which games this print is available on, from among paper, mtgo, and arena.",
    )
    highres_image: bool = Field(description="Whether this card has a high-res image available.")
    ...
    promo: bool = Field(description="Whether this print is a promo.")
    ...
    rarity: Rarity = Field(description="The rarity of this print.")
    related_uris: RelatedUrisModel = Field(description="Links to this print's listing on other online resources.")
    released_at: date = Field(description="The date this card was first released.")
    reprint: bool = Field(description="Whether this print is a reprint from an earlier set.")
    scryfall_set_uri: str = Field(description="Link to the Scryfall set page for the set of this print.")
    set_name: str = Field(description="Full name of the set this print belongs to.")
    set_search_uri: str = Field(description="Link to Scryfall API to start paginating through this print's full set.")
    set_type: SetType = Field(description="An overall categorization for each set, provided by Scryfall.")
    set_uri: str = Field(description="Link to the set for this print in Scryfall's API.")
    set_code: str = Field(
        alias="set",
        description="Set code of the set this print belongs to.",
    )
    set_id: str = Field(description="UUID of the set this print belongs to")
    story_spotlight: bool = Field(description="Whether this print is a Story Spotlight")
    textless: bool = Field(description="Whether this print is textless.")
    variation: bool = Field(description="Whether this card print is a variation of another card.")
