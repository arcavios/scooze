        ...
        case "test":
            try:
                with open("./data/test/test_cards.json") as cards_file:
                    ...
                    await db.add_cards(cards)  # TODO: this need async for now, replace with Python API [#7]
            except OSError as e:
